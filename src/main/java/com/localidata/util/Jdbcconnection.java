...
public class Jdbcconnection {
        ...
        public static void main (String args []) throws Exception{
                ...
                Span mainJdbcconnectionSpan = tracer.spanBuilder("Jdbcconnection main")
                        .setSpanKind(SpanKind.INTERNAL)
                        .startSpan();

                try (Scope scope = mainJdbcconnectionSpan.makeCurrent()){
                        ...
                        mainJdbcconnectionSpan.setAttribute(AttributeKey.stringKey("query_full"), query_full);
                        mainJdbcconnectionSpan.setAttribute(AttributeKey.stringKey("writer"), props.getProperty("WRITE_FILE"));
                        mainJdbcconnectionSpan.setAttribute(AttributeKey.stringKey("writerToTest"), "writerToTest.txt");
                        mainJdbcconnectionSpan.setAttribute(AttributeKey.stringKey("writer2"), props.getProperty("WRITE_FILE2"));
                        mainJdbcconnectionSpan.setAttribute(AttributeKey.stringKey("dbURL"), dbURL);
                        mainJdbcconnectionSpan.setAttribute(AttributeKey.stringKey("strUserID"), strUserID);
                        mainJdbcconnectionSpan.setAttribute(AttributeKey.stringKey("strPassword"), strPassword);
                                ...
                                if(valor.getDirweb() != null && !valor.getDirweb().substring(lenS,lenS+2).equals("06")){
                                        ...
                                        try (Scope scopeLoopQuery = loopQuerySpan.makeCurrent()){
                                                ...
                                                */
                                                ...
                                                loopQuerySpan.setAttribute(AttributeKey.stringKey("descripcionMejorada"), descripcionMejorada);
                        ...
                        mainJdbcconnectionSpan.recordException(e);
                        throw e;
                } finally {
                        mainJdbcconnectionSpan.end(); 
                }
